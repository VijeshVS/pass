...
import { sendResendMailForPass } from "../actions/details";
  ...
  return (
    <div
      ...
      className={`
        ...
        border-l-4 ${
          pass.type === "event" ? "border-orange-500" : "border-teal-500"
        }
      `}
    >
      <div className="p-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="text-sm">
              Updated: {formatDateTime(pass.updatedAt)}
            </span>
          </div>
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="text-sm">
              ...
              {pass.noOfParticipants === 1 ? "Participant" : "Participants"}
            </span>
          </div>
        </div>
